...
const REASON = {
  // The status-line copy lives in shared.localCopy — one source for
  // the server's reasons and the monitor's cards (LND's pattern).
  warmup: shared.localCopy.gray,
